...
var addButton=document.querySelector(".form__confirm");//first button
var incompleteTaskHolder=document.querySelector(".list");//ul of #incompleteTasks
var completedTasksHolder=Array.from(document.querySelectorAll(".list")).at(-1);//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    // Appoint class names to each element
    listItem.classList.add("task");
    checkBox.classList.add("task__check");
    label.classList.add("task__name");
    editInput.classList.add("task__input");
    editButton.classList.add("button", "task__edit");
    deleteButton.classList.add("button", "task__delete");
...
var addTask=function(){
    ...
    listItem.classList.add("task_active");
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task_mode_editing");
    ...
    listItem.classList.toggle("task_mode_editing");
};
...
var taskCompleted=function(){
    ...
    listItem.classList.remove("task_active");
